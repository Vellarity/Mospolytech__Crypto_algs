export const toBinary = (plain) =>{ //Перевод текста в двоичный формат UTF-8
  ...
  let bytes = bytesTemp.reduce((a,b) =>{
    return a.concat(b)
  })
...
export const binToStr = (bits) =>{ //Перевод двоичной последовательности в UTF-8 строку
